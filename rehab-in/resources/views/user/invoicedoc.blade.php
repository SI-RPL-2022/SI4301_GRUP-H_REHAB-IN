                    ...
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-md-4 col-sm-4">
                                <h4><img src="{{ asset('assets/style/images/kls-vip.png') }}" width="100" alt="velonic">
                                </h4>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 text-right">
                                ...
                                <p class="m-t-10"><strong>Order Status: </strong> <span
                                        class="badge bg-warning">{{ $inv->status }}</span></p>
                        ...
                        <div class="row" style="border-radius: 0px;">
                            <div class="col-md-12 text-right">
                                <hr>
                                <h3 class="text-right">Rp
                                    {{ number_format($inv->price, 0, ',', '.') }}</h3>
                            </div>
                        </div>
                        <hr>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="staticBackdropLabel">Upload file bukti pembayaran
                                            </h5>
                                        ...
                                        <div class="modal-body">
                                                ...
                                                <div class="accordion accordion-flush" id="accordionFlushExample">
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                                                            ...
                                                            <div class="accordion-body fw-bold" style="text-align: center;">
                                                                Masukan No. Rek, <code>232156732</code>. Jika sudah
                                                                melakukan pembayaran silahkan upload bukti pembayaran</div>
                                                        </div>
                                                    </div>
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                                            ...
                                                            data-bs-parent="#accordionFlushExample">
                                                            <div class="accordion-body fw-bold" style="text-align: center;">
                                                                Masukan No. Rek, <code>12356732</code>. Jika sudah melakukan
                                                                pembayaran silahkan upload bukti pembayaran</div>
                                                        </div>
                                                    </div>
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                                                            ...
                                                            data-bs-parent="#accordionFlushExample">
                                                            <div class="accordion-body fw-bold" style="text-align: center;">
                                                                Masukan No. Rek, <code>12322156732</code>. Jika sudah
                                                                melakukan pembayaran silahkan upload bukti pembayaran</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <form action="/pasien/orderd/" method="POST" enctype="multipart/form-data">
                                                ...
                                                <input type="text" name="layanan" value="{{ $inv->jenislayanan }}"
                                                    hidden>
