...
@section('main')
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="rounded text-center me-2 text-white" style="background-color:#67a5ff">
                    <img src="{{ asset('assets/style/images/KamarPasien.png') }}" class="mt-2" alt="Kamar Pasien">
                    <p class="p-1 text-white">Reservasi Kamar</p>
                </div>
            </div>
            <div class="col">
                <div class="rounded text-center me-2 bg-primary text-white">
                    <a href="{{ route('dokter')}}">"><img src="{{ asset('assets/style/images/Dokter.png') }}" class="mt-2" alt="Dokter">
    ...
    <div class="container">
        <p style="font-size:20px">Kamar yang tersedia</p>
        <div class="row">
